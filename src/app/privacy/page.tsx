...
export const metadata: Metadata = {
  ...
  description:
    "Політика конфіденційності RSF Solar — як ми збираємо, обробляємо та зберігаємо ваші персональні дані.",
};
  ...
  return (
    <>
      <PageHero
        eyebrow="Документ"
        title="Політика конфіденційності"
        description="Цей документ описує, як RSF Solar збирає, обробляє та зберігає персональні дані користувачів сайту та клієнтів."
      ...
      <section className="bg-white pb-24">
        <Container>
          <article className="prose-custom mx-auto max-w-3xl space-y-6 text-ink-700 leading-relaxed">
            <p>
              RSF Solar дотримується вимог Закону України "Про захист
