...
export const metadata: Metadata = {
  title: "Про компанію",
  description:
    "RSF Solar — українська інжинірингова компанія з 12-річним досвідом будівництва альтернативної енергетики.",
};
  ...
  return (
    <>
      <PageHero
        ...
        description="RSF Solar — українська компанія, яка проектує та будує об'єкти відновлюваної енергетики. Понад 240 завершених проектів в Україні та Європі."
          ...
          <div className="grid gap-12 lg:grid-cols-12">
            <div className="relative aspect-[4/5] overflow-hidden rounded-[32px] lg:col-span-5">
              <Image
                ...
                alt="Команда RSF Solar на об'єкті"
                fill
            ...
            <div className="lg:col-span-7">
              ...
              <p className="mt-6 text-lg leading-relaxed text-ink-600">
                RSF Solar народилася у 2014 році, коли троє інженерів зрозуміли:
              ...
              <p className="mt-5 text-ink-600 leading-relaxed">
                Сьогодні RSF Solar — це EPC-підрядник з власним проектним бюро,
